...
const Page_SIGN_up  = ({navigation}) => {
	...
	<ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{height: Dimensions.get("window").height}}>
		<View style = {noneModeStyles._page9}    >
			...
			<Text style = {noneModeStyles._Create_account_}   >
				Create account!
			</Text>
			<Text style = {noneModeStyles._Sign_up_to_get_started}   >
			...
			<Text style = {noneModeStyles._Surname}   >
				Surname
			</Text>
			...
			<Text style = {noneModeStyles._By_Joining_you_agree_to_our_Terms___Services_policy}   >
				By Joining you agree to our Terms & Services policy 
			</Text>
			...
			<Text style = {noneModeStyles._Sign_in_with_Facebook}   >
				Sign in with Facebook
			</Text>
			<Text style = {noneModeStyles._OR}   >
				OR
			</Text>
			<Text style = {noneModeStyles._Sign_in_with_google_}   >
				Sign in with google+
			</Text>
...
_By_Joining_you_agree_to_our_Terms___Services_policy: {
	width: "auto",
	height: "auto",
	position: "absolute",
	left: 33,
