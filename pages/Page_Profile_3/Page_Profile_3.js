...
const Page_Profile_3  = ({navigation}) => {
	useEffect(() => {
	}, []);
	return (
	...
	<ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{height: Dimensions.get("window").height}}>
		<View style = {noneModeStyles._page4}    >
			...
			<View style = {noneModeStyles._Frame_43}    >
				<View style = {noneModeStyles._Group_5098}    >
					<View style = {noneModeStyles._Group_4988}    >
						...
						<Text style = {noneModeStyles._Amelia_Tray}   >
							Amelia Tray
						</Text>
						<Text style = {noneModeStyles._Offering_Stud___Looking_for_Stud_}   >
							Offering Stud & Looking for Stud!
						</Text>
					</View>
					<View style = {noneModeStyles._Group_5095}    >
						<View style = {noneModeStyles._Rectangle_990}    >
						</View>
						<Text style = {noneModeStyles._Additional_Information}   >
							Additional Information
						</Text>
						<Text style = {noneModeStyles._10_Feb_2000}   >
							10-Feb-2000
						</Text>
						<Text style = {noneModeStyles._Birthday}   >
							Birthday
						</Text>
						<Text style = {noneModeStyles._Address}   >
							Address
						</Text>
						<Text style = {noneModeStyles._Postal_Code}   >
							Postal Code
						</Text>
					</View>
					<View style = {noneModeStyles._Group_4986}    >
						<View style = {noneModeStyles._Rectangle_989}    >
						</View>
						<Text style = {noneModeStyles._Preferences}   >
							Preferences
						</Text>
						<Text style = {noneModeStyles._Language}   >
							Language
						</Text>
						<Text style = {noneModeStyles._English}   >
							English
						</Text>
						<Text style = {noneModeStyles._Public_Profile}   >
							Public Profile
						</Text>
						<View style = {noneModeStyles._Rectangle_991}    >
						</View>
						<View style = {noneModeStyles._Rectangle_992}    >
						</View>
						<View style = {noneModeStyles._ls_dropdown}    >
							<View style = {noneModeStyles.style60}    >
								<View style = {noneModeStyles.style61}   >
									<Svg style={{height: 10, width: 16}} viewBox = "0 0 16 10">
										<Path fill = {"#7C7C7C"}     d = "M15.6701 1.29663L9.08932 9.05193C8.46505 9.76141 7.50265 9.76141 6.9044 9.05193L0.323631 1.29663C-0.300631 0.562688 0.0115003 0 0.973905 0H15.0198C16.0082 0 16.2943 0.562688 15.6701 1.29663Z"/>
									</Svg>
								</View>
							</View>
						</View>
					</View>
					<View style = {noneModeStyles._Group_5145}    >
						<View style = {noneModeStyles._Rectangle_1052}    >
						</View>
						<View style = {noneModeStyles._Rectangle_1053}    >
						</View>
					</View>
					<Text style = {noneModeStyles._432_Followers}   >
						432 Followers
					</Text>
					<Text style = {noneModeStyles._345_Following}   >
						345 Following
					</Text>
				</View>
			</View>
...
_Offering_Stud___Looking_for_Stud_: {
	width: "auto",
	height: "auto",
	position: "absolute",
	left: 0,
